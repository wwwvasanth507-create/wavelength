...
| **Reverse Proxy** | Nginx HTTP Server (Port 80/443 -> Port 7000) | `/etc/nginx/sites-available/wavelength` |
...
6. Registers and enables systemd service `wavelength.service` on port 7000.
